...
var _shake_noise setget _set_shake_noise,_get_shake_noise 


func anima_method(method: FuncRef,from,to_value,duration: float) -> HoneyShake:
	_set_method(method)
	_set_from(from)
	_set_to(to_value)
...
func on_started(func_ref: FuncRef) -> HoneyShake:
	_set_on_started(func_ref)
	return self


func on_step(func_ref: FuncRef) -> HoneyShake:
	_set_on_step(func_ref)
	return self


func on_running(func_ref: FuncRef) -> HoneyShake:
	_set_on_running(func_ref)
	return self


func on_finished(func_ref: FuncRef) -> HoneyShake:
	_set_on_finished(func_ref)
	return self


func on_loop_finished(func_ref: FuncRef) -> HoneyShake:
	_set_on_loop_finished(func_ref)
	return self


func on_infinity_loop_finished(func_ref: FuncRef) -> HoneyShake:
	_set_on_infinity_loop_finished(func_ref)
	return self


func on_delay_finished(func_ref: FuncRef) -> HoneyShake:
	_set_on_delay_finished(func_ref)
	return self


func on_rewind(func_ref: FuncRef) -> HoneyShake:
	_set_on_rewind(func_ref)
	return self


func on_paused(func_ref: FuncRef) -> HoneyShake:
	_set_on_paused(func_ref)
	return self


func on_flip(func_ref: FuncRef) -> HoneyShake:
	_set_on_flip(func_ref)
	return self


func update_from() -> HoneyShake:
	return self


func play() -> HoneyShake:
	_handle_started()
	return self


func set_speed_scale(value: float) -> HoneyShake:
	_set_speed_scale(value)
	return self


func set_delay(value: float) -> HoneyShake:
	_set_delay(value)
	_set_initial_delay(value)
	return self


func set_loops(value: int,loop_type: String = LoopType.Restart) -> HoneyShake:
	_set_loop_count(value)
	_set_loop_type(loop_type)
	return self
	
	
func paused() -> HoneyShake:
	_set_paused(true)
	emit_signal("animation_paused")
	return self


func resume() -> HoneyShake:
	_set_paused(false)
	return self


func reset() -> HoneyShake:
	_set_started(false)
	_set_playing(false)
	_set_finished(false)
	_set_paused(false)
...
func set_ease(value) -> HoneyShake:
	_set_ease(value)
	return self


#func set_shake_noise(value: Resource) -> HoneyShake:
	#_set_shake_noise(value)
	#return self


func _set_target(value: Object) -> HoneyShake:
	_target = value
	return self
...
func _set_shake_noise(value) -> void:
	_shake_noise = value


func _get_shake_noise():
	return _shake_noise
